# orcid_service_client.HealthcheckApi
...
from orcid_service_client.models.health_check import HealthCheck
...
with orcid_service_client.ApiClient(configuration) as api_client:
    ...
    api_instance = orcid_service_client.HealthcheckApi(api_client)
